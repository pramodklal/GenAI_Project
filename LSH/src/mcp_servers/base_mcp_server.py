"""
Healthcare Digital - MCP Server Base Class

Provides standardized interface for all MCP servers in the system.
"""
...
class MCPServerBase(ABC):
    """Base class for all MCP servers in Healthcare Digital system."""
