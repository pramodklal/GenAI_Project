...
```bash
streamlit run ui/Core_Service.py
```

The application will open at `http://localhost:8501` with 7 pages:
- 🍽️ Meal Ordering - AI-powered meal validation
- 🍳 Food Production - Demand forecasting and waste reduction
- 🧹 EVS Management - Smart task prioritization
- 📊 Analytics - Performance metrics
- 📁 Data Import - CSV upload to Astra DB
...
├── ui/
│   ├── Core_Service.py          # Main Streamlit app
│   └── pages/
│       ├── 1_🍽️_Meal_Ordering.py
│       ├── 2_🍳_Food_Production.py
│       ├── 3_🧹_EVS_Management.py
│       ├── 4_📊_Analytics.py
│       ├── 5__Data_Import.py
│       ├── 6__System_Status.py
│       └── 7_👤_Add_Patient.py
├── database/
│   ├── astra_helper.py          # Database operations
│   └── astra_db_schema.py       # Schema definitions
├── examples/
